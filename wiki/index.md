...
* [The frame is bigger than your locals account for](observations/frame-size-counts-locals/observation.md) - the ENTER operand is declared locals plus the code generator's temporaries, so it measures the source's var block before you read a single statement
